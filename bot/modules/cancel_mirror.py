...
async def cancell_all_buttons(_, message):
    ...
    buttons.ibutton("Downloading", f"canall {MirrorStatus.STATUS_DOWNLOADING}", style='blue')
    buttons.ibutton("Uploading", f"canall {MirrorStatus.STATUS_UPLOADING}", style='blue')
    buttons.ibutton("Seeding", f"canall {MirrorStatus.STATUS_SEEDING}", style='blue')
    buttons.ibutton("Cloning", f"canall {MirrorStatus.STATUS_CLONING}", style='blue')
    buttons.ibutton("Extracting", f"canall {MirrorStatus.STATUS_EXTRACTING}", style='blue')
    buttons.ibutton("Archiving", f"canall {MirrorStatus.STATUS_ARCHIVING}", style='blue')
    buttons.ibutton("QueuedDl", f"canall {MirrorStatus.STATUS_QUEUEDL}", style='blue')
    buttons.ibutton("QueuedUp", f"canall {MirrorStatus.STATUS_QUEUEUP}", style='blue')
    buttons.ibutton("Paused", f"canall {MirrorStatus.STATUS_PAUSED}", style='blue')
    buttons.ibutton("All", "canall all", style='blue')
    buttons.ibutton("Close", "canall close", style='red')
