...
async def list_buttons(user_id, isRecursive=True):
    buttons = ButtonMaker()
    buttons.ibutton("Only Folders", f"list_types {user_id} folders {isRecursive}", style='blue')
    buttons.ibutton("Only Files", f"list_types {user_id} files {isRecursive}", style='blue')
    buttons.ibutton("Both", f"list_types {user_id} both {isRecursive}", style='blue')
    buttons.ibutton(f"{'✅️' if isRecursive else ''} Recursive", f"list_types {user_id} rec {isRecursive}", style='green' if isRecursive else 'blue')
    buttons.ibutton("Cancel", f"list_types {user_id} cancel", style='red')
