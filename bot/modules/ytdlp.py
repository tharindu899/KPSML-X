...
class YtSelection:
    ...
    async def get_quality(self, result):
        ...
        if 'entries' in result:
            ...
            buttons.ibutton('MP3', 'ytq mp3', style='blue')
            buttons.ibutton('Audio Formats', 'ytq audio', style='blue')
            buttons.ibutton('Best Videos', 'ytq bv*+ba/b', style='blue')
            buttons.ibutton('Best Audios', 'ytq ba/b', style='blue')
            buttons.ibutton('Cancel', 'ytq cancel', 'footer', style='red')
            ...
            buttons.ibutton('MP3', 'ytq mp3', style='blue')
            buttons.ibutton('Audio Formats', 'ytq audio', style='blue')
            buttons.ibutton('Best Video', 'ytq bv*+ba/b', style='blue')
            buttons.ibutton('Best Audio', 'ytq ba/b', style='blue')
            buttons.ibutton('Cancel', 'ytq cancel', 'footer', style='red')
    ...
    async def qual_subbuttons(self, b_name):
        ...
        buttons.ibutton('Back', 'ytq back', 'footer', style='blue')
        buttons.ibutton('Cancel', 'ytq cancel', 'footer', style='red')
    ...
    async def mp3_subbuttons(self):
        ...
        buttons.ibutton('Back', 'ytq back', style='blue')
        buttons.ibutton('Cancel', 'ytq cancel', style='red')
    ...
    async def audio_quality(self, format):
        ...
        buttons.ibutton('Back', 'ytq aq back', style='blue')
        buttons.ibutton('Cancel', 'ytq aq cancel', style='red')
...
async def _ytdl(client, message, isLeech=False, sameDir=None, bulk=[]):
    ...
    if not is_url(link):
        btn = ButtonMaker()
        btn.ibutton('Cʟɪᴄᴋ Hᴇʀᴇ Tᴏ Rᴇᴀᴅ Mᴏʀᴇ ...', f'kpsmlx {message.from_user.id} help YT', style='blue')
